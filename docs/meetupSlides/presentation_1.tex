...
\title[TDD com Android]{Introdução A Testes de Unidade e Aplicativos Android} % The short title appears at the bottom of every slide, the full title is only on the title page
